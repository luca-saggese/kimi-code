...
<template>
  <div class="gload" role="status" :aria-label="t('app.connecting')">
    <div class="gload-box">
      <svg v-if="brand.productName === 'Kimi'" class="gload-logo" viewBox="0 0 96 32" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      ...
      <div v-else class="gload-logo-text">{{ brand.productName }}</div>
